...
This module provides functions to manage product inventory
including adding/removing items,saving/loading data,checking stock levels.
"""
...
def remove_item(item, qty):
    ...
    try:
        ...
        print(f"Error: Invalid type for quantity - {exc}")
...
def load_data(file="inventory.json"):
    ...
    try:
        ...
        print(f"Warning: File '{file}' not found, started with empty inv")
        stock_data = {}
